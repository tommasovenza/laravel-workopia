<x-layout>
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('update', $job->id)}}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="title" :value="old($job->title)" name="title" label="Job Title" placeholder="Software Engineer" />
    
            {{-- Textarea Job Description --}}
            <x-inputs.text-area :value="old($job->description)" label="Job Description" id="description" name="description" placeholder="We are seeking a skilled and motivated Software Developer to join our growing development team..." />
